...
Template.images.helpers({
  ...
  getImgSrc:function(){
    ...
    } catch (e) {} // throws an exception that findOne is not defined for some reason
  },
...
Template.images.events({
  ...
  'submit .js-edit-item':function(event){
      ...
      var img_src, watch_code, watch_price, watch_category, watch_description;
...
Template.add_item_form.events({
  'submit .js-add-item':function(event){
    var img_src, watch_code, watch_price, watch_category, watch_description;
      ...
      watch_code = event.target.watch_code.value;
      watch_price = event.target.watch_price.value;
      watch_category = event.target.watch_code.value;
      watch_description = event.target.watch_code.value;
